                ...
                <div id="collapseExample" class="collapse show">
                  <div class="card card-body">
                    <p>
                      ...
                      In this article, we'll take a closer look at Nusa Penida and
                      provide you with some tips for planning your trip.
                      <br /><br />
                      The easiest way to get to Nusa Penida is to take a fast boat
                      from Sanur or Padang Bai. The journey takes approximately 45
                      minutes to 1 hour, depending on the sea conditions. You can
                      also take a ferry from Padang Bai, which is cheaper but
                      takes longer.
                    </p>
                  </div>
                </div>
                <div id="collapseExample2" class="collapse">
                  <div class="card card-body">
                    ...
                    <div class="destination">
                      <span
                        ><i class="icon fa-solid fa-map-location"></i>Destination</span
                      >
